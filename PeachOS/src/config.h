...
#define PEACHOS_HEAP_SIZE_BYTES 104857600 // 100MB heap size
#define PEACHOS_HEAP_BLOCK_SIZE 4096 // block size
#define PEACHOS_HEAP_ADDRESS 0x01000000 // heap address
